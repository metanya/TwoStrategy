...
class Record:
    ...
    def get_main_attributes(self):
        ...
        genes_in_genome = (genes_seq_len / genome_size)
        assert_percentage(genes_in_genome)
        self.main_attributes_dictionary["%genes_in_genome"] = genes_in_genome * 100
        ...
        #                      self.main_attributes_dictionary["gene"]) / genome_size) * 100
